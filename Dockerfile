# DOCKER-VERSION 1.4.9
FROM    ubuntu

MAINTAINER Have-Purple <have-purple@nannerb.org>
...
RUN echo 'ls -la /dev/video0 && mjpg_streamer -o "output_http.so -w ./www -p 8080" -i "input_uvc.so mjpg_streamer -r 1920x1080 -f 30"' > /start.sh && chmod a+rx /start.sh
